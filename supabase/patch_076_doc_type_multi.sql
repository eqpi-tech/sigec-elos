-- patch_076_doc_type_multi.sql (18/09)
-- Análise de Docs: p_doc_type aceita MÚLTIPLOS tipos (lista separada por
-- vírgula) — o filtro da tela virou múltipla escolha com busca.
-- Mesma assinatura do patch_075; só muda a condição do tipo.
