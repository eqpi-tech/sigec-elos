-- patch_078_hoc_analysis_due.sql (18/09)
-- Farol fiel ao HOC de ponta a ponta: espelha a data_limite_analise do HOC
-- (documents.hoc_analysis_due). O farol/fila usam a data do HOC quando
-- existir; sem ela (docs ELOS-nativos ou os "fantasmas" NULL do HOC),
-- calculam envio + 3 dias úteis.

ALTER TABLE documents ADD COLUMN IF NOT EXISTS hoc_analysis_due date;

CREATE OR REPLACE FUNCTION public.doc_analysis_due(d documents)
