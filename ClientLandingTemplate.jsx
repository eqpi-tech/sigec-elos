...
const DEMO_CLIENT = {
  slug: "engeform",
  companyName: "Engeform Engenharia",
  logoUrl: "https://placehold.co/220x60/1B2A4A/ffffff?text=ENGEFORM&font=montserrat",
  heroImage: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=1400&q=80",
  accentColor: "#F47E2F",
  description:
    "Ao longo dos anos de história da Engeform Engenharia, em cada projeto, buscamos a excelência. Já são mais de 630 empreendimentos por todo o país, atuando nos segmentos da saúde, saneamento, edificações, energia e infraestrutura.",
  complianceUrl: "https://www.engeform.com.br/compliance",
  linkedinUrl: "https://linkedin.com/company/engeform",
  websiteUrl: "https://www.engeform.com.br",
  contactEmail: "fornecedores@engeform.com.br",
  badges: ["ISO 9001", "ISO 14001", "ESG"],
};
...
// ─── MAIN COMPONENT ───
export default function ClientLandingTemplate() {
  const client = DEMO_CLIENT;
  const accent = client.accentColor || "#F47E2F";
  ...
  const handleRegister = () => {
    ...
    const url = `https://elos.eqpitech.com.br/register?cnpj=${raw}&ref=${client.slug}`;
    window.open(url, "_blank");
  };

  const handleLogin = () => {
    window.open("https://elos.eqpitech.com.br/login", "_blank");
  };
  ...
  const CSS = `
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .btn-primary { background: ${accent}; color: #fff; border: none; padding: 14px 32px;
      ...
      font-family: ${font}; letter-spacing: 0.3px; transition: all 0.25s; }
    ...
    .btn-outline { background: transparent; color: #fff; border: 1.5px solid rgba(255,255,255,0.35);
      ...
      cursor: pointer; font-family: ${font}; transition: all 0.25s; }
    ...
    <div style={{ background: "#FAFBFC", minHeight: "100vh", fontFamily: font }}>
      ...
      >
        <div style={{ maxWidth: 1120, margin: "0 auto", display: "flex",
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            <img src={client.logoUrl} alt={client.companyName}
      ...
      <header
        style={{
          ...
          overflow: "hidden", paddingTop: mobile ? 100 : 0,
      ...
      >
        ...
        <div style={{
          ...
          background: "radial-gradient(circle, rgba(91,127,165,0.12), transparent 70%)",
        }} />

        <div style={{
          position: "relative", zIndex: 2, maxWidth: 1120,
          ...
          <div>
            ...
            <h1 style={{
              fontFamily: fontDisplay, fontSize: mobile ? 36 : 52,
              fontWeight: 700, color: "#fff", lineHeight: 1.15, marginBottom: 20,
            }}>
              Seja fornecedor da{" "}
              <span style={{ color: accent }}>{client.companyName}</span>
            </h1>

            <p style={{
              fontSize: mobile ? 16 : 18, color: "rgba(255,255,255,0.65)",
              lineHeight: 1.7, maxWidth: 520, marginBottom: 32,
            }}>
              Cadastre-se na plataforma de pré-homologação <strong style={{ color: "rgba(255,255,255,0.85)" }}>SIGEC-ELOS</strong>,
              valide sua documentação e torne-se visível para oportunidades de negócio
              com a {client.companyName}.
            </p>
          ...
          {/* Right side — Registration / Login Card */}
              ...
              {activeTab === "register" ? (
                <>
                  <p style={{ fontSize: 14, color: "rgba(255,255,255,0.6)", marginBottom: 20, lineHeight: 1.6 }}>
                    ...
                    como fornecedor da <strong style={{ color: "#fff" }}>{client.companyName}</strong>.
                  </p>
                  ...
                  <p style={{ fontSize: 12, color: "rgba(255,255,255,0.35)", marginTop: 14,
                    ...
                    da {client.companyName} na plataforma SIGEC-ELOS.
                  </p>
                </>
              ) : (
                <>
                  ...
                  <p style={{ fontSize: 13, color: accent, textAlign: "center",
        ...
        {!mobile && (
          <div style={{
            ...
            <span style={{ fontSize: 11, color: "rgba(255,255,255,0.3)", letterSpacing: 2, fontWeight: 500 }}>
              SCROLL
            </span>
      ...
      <Section id="sobre">
        <div style={{
          ...
          <div>
            <span style={{
              fontSize: 12, fontWeight: 700, letterSpacing: 2, color: accent,
            ...
            {client.complianceUrl && (
              <a href={client.complianceUrl} target="_blank" rel="noopener noreferrer"
                style={{
                  display: "inline-flex", alignItems: "center", gap: 8,
                  marginTop: 24, fontSize: 14, fontWeight: 600, color: accent,
                  textDecoration: "none",
                }}>
          ...
          <div style={{
            background: "#F2F4F7", borderRadius: 20, padding: 40,
            ...
            {[
              ...
              <div key={item.label} style={{ display: "flex", gap: 16, alignItems: "flex-start" }}>
                ...
                <div>
                  <h4 style={{ fontSize: 15, fontWeight: 600, marginBottom: 4, color: "#0D1B2A" }}>
                    {item.label}
                  </h4>
      ...
      <Section id="processo" dark>
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          ...
          <h2 style={{ fontFamily: fontDisplay, fontSize: mobile ? 28 : 36,
            fontWeight: 700, marginTop: 12, color: "#fff" }}>
        ...
        <div style={{
          ...
          {[
            ...
            <div key={step.n} style={{
              ...
              <h3 style={{ fontSize: 17, fontWeight: 600, marginBottom: 10, color: "#fff" }}>
                {step.title}
              </h3>
      ...
      <Section id="planos" style={{ background: "#F7F8FA" }}>
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          ...
          <h2 style={{ fontFamily: fontDisplay, fontSize: mobile ? 28 : 36,
            fontWeight: 700, marginTop: 12, color: "#0D1B2A" }}>
            Escolha o plano ideal para sua empresa
          </h2>
          <p style={{ fontSize: 16, color: "#667085", marginTop: 12, maxWidth: 580,
            margin: "12px auto 0" }}>
            Assinatura anual com valores acessíveis. A {client.companyName} não recebe
        ...
        <div style={{
          ...
          {ELOS_PLANS.map((plan) => (
            <div key={plan.id} className={`plan-card${plan.popular ? " popular" : ""}`}>
              ...
              <h3 style={{ fontSize: 20, fontWeight: 700, color: "#0D1B2A", marginBottom: 4 }}>
                {plan.name}
              </h3>
              <div style={{ marginBottom: 24 }}>
                <span style={{ fontSize: 14, color: "#667085" }}>R$</span>
                <span style={{ fontSize: 44, fontWeight: 700, color: plan.color, marginLeft: 2 }}>
                  {plan.price}
                </span>
              ...
              <ul style={{ listStyle: "none", padding: 0, margin: "0 0 28px 0" }}>
                {plan.features.map((f, i) => (
                  <li key={i} style={{
                    fontSize: 14, color: "#475467", padding: "8px 0",
                    borderBottom: i < plan.features.length - 1 ? "1px solid #F2F4F7" : "none",
                    display: "flex", gap: 10, alignItems: "flex-start",
                  }}>
                    <span style={{ color: plan.color, fontWeight: 700, fontSize: 16, lineHeight: 1 }}>✓</span>
                    {f}
                  </li>
                ))}
              </ul>
              <button className="btn-primary" onClick={() => {
                ...
                width: "100%", background: plan.popular ? accent : "#1B2A4A",
              }}>
                {plan.cta}
              </button>
            </div>
        ...
        <p style={{ textAlign: "center", fontSize: 13, color: "#98A2B3", marginTop: 28, lineHeight: 1.6 }}>
          Os valores são direcionados a empresas brasileiras com CNPJs ativos na Receita Federal do Brasil.
          <br />Pagamento processado com segurança via Stripe.
        </p>
      </Section>
      ...
      <Section style={{ padding: "48px 24px", background: "#fff", borderTop: "1px solid #E4E7EC" }}>
        <div style={{
          ...
          alignItems: "center", justifyContent: "center", gap: mobile ? 20 : 48,
          textAlign: "center",
        }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <div style={{
              width: 40, height: 40, borderRadius: 10, background: "#0D1B2A",
              display: "flex", alignItems: "center", justifyContent: "center",
      ...
      <Section dark style={{
        ...
        <h2 style={{
          fontFamily: fontDisplay, fontSize: mobile ? 28 : 40,
          fontWeight: 700, color: "#fff", marginBottom: 16,
        }}>
          Pronto para ser fornecedor da {client.companyName}?
        </h2>
        ...
        <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
          ...
          {client.contactEmail && (
            <a href={`mailto:${client.contactEmail}`} className="btn-outline" style={{ fontSize: 16, padding: "16px 40px" }}>
              Falar com a Empresa
            </a>
          )}
        </div>
      ...
      {/* ═══ FOOTER ═══ */}
      <footer style={{
        background: "#060D16", padding: "40px 24px", textAlign: "center",
        ...
        <div style={{ maxWidth: 1120, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 12, color: "rgba(255,255,255,0.25)", lineHeight: 1.6 }}>
            ...
            A {client.companyName} não obtém resultado financeiro com as anuidades pagas à EQPI Tech.
          </p>
